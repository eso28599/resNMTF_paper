...
The runtime for this document without the real data applications is approximatley (on an M4 Macbook Pro with 16GB RAM) <b>3 hours</b>. The runtime for the real data applications is approximately 1-2 days each (on a cluster).
</div>
