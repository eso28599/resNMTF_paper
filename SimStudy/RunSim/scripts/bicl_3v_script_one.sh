#!/bin/bash
#PBS -N increasing_bicl_3v
#PBS -m a
#PBS -q medium
#PBS -t 1-100
#PBS -o ../Results/bicl/bicl_3v/logs/test_job.out
#PBS -e ../Results/bicl/bicl_3v/logs/test_job.err

export R_LIBS="/home/clustor2/ma/e/eso18/R/x86_64-pc-linux-gnu-library/4.3"
export sim_folder_name=Results/bicl/bicl_3v
export sim=bicl
