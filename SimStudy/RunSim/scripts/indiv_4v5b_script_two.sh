#!/bin/bash
#PBS -N inc_indiv_3v5b_res
#PBS -m a
#PBS -q medium
#PBS -o ../Results/indiv/indiv_4v5b/logs/results.out
#PBS -e ../Results/indiv/indiv_4v5b/logs/results.err

export R_LIBS="/home/clustor2/ma/e/eso18/R/x86_64-pc-linux-gnu-library/4.3"
export sim_folder_name=Results/indiv_4v5b
export sim=indiv
