#!/bin/bash
#PBS -N increasing_indiv_3v4b
#PBS -m a
#PBS -q medium
#PBS -t 12
#PBS -o ../Results/indiv/indiv_3v4b/logs/test_job.out
#PBS -e ../Results/indiv/indiv_3v4b/logs/test_job.err

export R_LIBS="/home/clustor2/ma/e/eso18/R/x86_64-pc-linux-gnu-library/4.3"
export sim_folder_name=Results/indiv/indiv_3v4b
export sim=indiv
