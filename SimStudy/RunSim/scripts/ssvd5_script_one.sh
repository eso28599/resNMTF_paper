...
#PBS -q medium
#PBS -t 1-100
#PBS -o Results/issvd_param_signal5/issvd_param/logs/test_job.out
#PBS -e Results/issvd_param_signal5/issvd_param/logs/test_job.err

export R_LIBS="/home/clustor4/ma/e/eso18/R/x86_64-pc-linux-gnu-library/4.4"
# export R_LIBS="/usr/local/lib/R/site-library"
export sim_folder_name=issvd_param_signal5/issvd_param
export sim=issvd
