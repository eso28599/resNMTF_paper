...
measures <- c("F_score", "Rel", "Rec", "CSR", "BiS", "Restrictions")
...
results_nmtf <- subset(results, Method == "iSSVD")
measures <- c("F score", "Relevance", "Recovery", "CSR", "BiS", "Restrictions")
if(phi_constant){
...
plot_res_nmtf <- make_plot_line_phi(results_nmtf, "Overall", plot_title,
                subhead, x_title, "Measure",
                path_to_save, measures)
if(phi_constant){
        #now produce one plot for each measure
        measures <- c("Relevance", "Recovery", "F score", "BiS", "CSR", "Restrictions")
        n_measures <- length(measures)
        measure_vec <-  c("Rel", "Rec", "F_score", "BiS", "CSR", "Restrictions")
...
col_names <- c("Measure", "F score", "Relevance", "Recovery", "CSR", "BiS", "Restrictions")
