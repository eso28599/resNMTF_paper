...
measures <- c("F score", "Relevance", "Recovery", "CSR", "BiS")
if(phi_constant){
...
plot_res_nmtf <- make_plot_line_issvd(results_nmtf, "Overall", x_title, "Measure",
                path_to_save, measures)
if(phi_constant){
        #now produce one plot for each measure
        measures <- c("Relevance", "Recovery", "F score",
                      "BiS", "CSR", "Restrictions")
